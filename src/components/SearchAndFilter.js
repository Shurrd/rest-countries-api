    ...
    <div>
      {!darkMode ? (
        <div className="flex xl:flex-row xl:justify-between flex-col mt-10">
          <form
            className="my-6 h-16 w-[95%] xl:w-[33%] left-0 right-0 mx-auto search flex flex-row items-center xl:mx-14"
          ...
          <div className="xl:my-auto my-8 mx-4 xl:mx-14 w-[40%] xl:w-[12%] ">
        ...
        <div className="flex xl:flex-row xl:justify-between flex-col mt-10">
          ...
          <div className="xl:my-auto my-8 mx-6 xl:mx-14 w-[40%] xl:w-[12%]">
            <select className="h-16 text-xl pl-4 w-full filter-search outline-none border border-gray-50">
              {allRegions.map((item, index) => (
